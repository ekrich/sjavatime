...
object ChronoField {
  ...
  final val NANO_OF_SECOND = new ChronoField("NanoOfSecond",
                                             0,
  ...
  final val NANO_OF_DAY = new ChronoField("NanoOfDay",
                                          1,
  ...
  final val MICRO_OF_SECOND = new ChronoField("MicroOfSecond",
                                              2,
  ...
  final val MICRO_OF_DAY = new ChronoField("MicroOfDay",
                                           3,
  ...
  final val MILLI_OF_SECOND = new ChronoField("MilliOfSecond",
                                              4,
                                              ValueRange.of(0, 999),
                                              MILLIS,
                                              SECONDS,
  ...
  final val MILLI_OF_DAY = new ChronoField("MilliOfDay",
                                           5,
  ...
  final val SECOND_OF_MINUTE = new ChronoField("SecondOfMinute",
                                               6,
                                               ValueRange.of(0, 59),
                                               SECONDS,
                                               MINUTES,
  ...
  final val SECOND_OF_DAY = new ChronoField("SecondOfDay",
                                            7,
  ...
  final val MINUTE_OF_HOUR = new ChronoField("MinuteOfHour",
                                             8,
                                             ValueRange.of(0, 59),
                                             MINUTES,
                                             HOURS,
  ...
  final val MINUTE_OF_DAY = new ChronoField("MinuteOfDay",
                                            9,
  ...
  final val HOUR_OF_AMPM = new ChronoField("HourOfAmPm",
                                           10,
                                           ValueRange.of(0, 11),
                                           HOURS,
                                           HALF_DAYS,
  ...
  final val CLOCK_HOUR_OF_AMPM = new ChronoField("ClockHourOfAmPm",
                                                 11,
                                                 ValueRange.of(1, 12),
                                                 HOURS,
                                                 HALF_DAYS,
  ...
  final val HOUR_OF_DAY = new ChronoField("HourOfDay",
                                          12,
                                          ValueRange.of(0, 23),
                                          HOURS,
                                          DAYS,
  ...
  final val CLOCK_HOUR_OF_DAY = new ChronoField("ClockHourOfDay",
                                                13,
                                                ValueRange.of(1, 24),
                                                HOURS,
                                                DAYS,
  ...
  final val AMPM_OF_DAY = new ChronoField("AmPmOfDay",
                                          14,
                                          ValueRange.of(0, 1),
                                          HALF_DAYS,
                                          DAYS,
  ...
  final val DAY_OF_WEEK = new ChronoField("DayOfWeek",
                                          15,
                                          ValueRange.of(1, 7),
                                          DAYS,
                                          WEEKS,
  ...
  final val ALIGNED_DAY_OF_WEEK_IN_MONTH = new ChronoField(
  ...
  final val ALIGNED_DAY_OF_WEEK_IN_YEAR = new ChronoField(
  ...
  final val DAY_OF_MONTH = new ChronoField("DayOfMonth",
                                           18,
  ...
  final val DAY_OF_YEAR = new ChronoField("DayOfYear",
                                          19,
  ...
  final val EPOCH_DAY = new ChronoField(
    "EpochDay",
    20,
  ...
  final val ALIGNED_WEEK_OF_MONTH = new ChronoField("AlignedWeekOfMonth",
                                                    21,
                                                    ValueRange.of(1, 4, 5),
                                                    WEEKS,
                                                    MONTHS,
  ...
  final val ALIGNED_WEEK_OF_YEAR = new ChronoField("AlignedWeekOfYear",
                                                   22,
                                                   ValueRange.of(1, 53),
                                                   WEEKS,
                                                   YEARS,
  ...
  final val MONTH_OF_YEAR = new ChronoField("MonthOfYear",
                                            23,
                                            ValueRange.of(1, 12),
                                            MONTHS,
                                            YEARS,
  ...
  final val PROLEPTIC_MONTH = new ChronoField(
    "ProlepticMonth",
    24,
  ...
  final val YEAR_OF_ERA = new ChronoField(
    "YearOfEra",
    25,
  ...
  final val YEAR = new ChronoField(
    "Year",
    26,
  ...
  final val ERA = new ChronoField("Era",
                                  27,
                                  ValueRange.of(0, 1),
                                  ERAS,
                                  FOREVER,
  ...
  final val INSTANT_SECONDS = new ChronoField(
    "InstantSeconds",
    28,
  ...
  final val OFFSET_SECONDS = new ChronoField("OffsetSeconds",
                                             29,
